...
Alternatively, if you want to play this locally, it will need to be ran through a local server on your machine (e.g. the Live Server extension for VS Code or python's http server) to load the assets correctly.
